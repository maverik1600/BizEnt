...
public final class SQLiteDB implements Database {
    ...
    public boolean createTables() {
        ...
        /* Inversiones pid = 4 */
        if (executeUpdate("INSERT INTO categorias (id, pid, nombre) values (50, 2, 'Plazo Fijo')"))    { return true; }
        if (executeUpdate("INSERT INTO categorias (id, pid, nombre) values (51, 3, 'Plazo Fijo')"))    { return true; }
